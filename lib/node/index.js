...
function request(method, url, opts) {
  ...
  if ('function' == typeof url) {
    return new exports.Request('GET', method, opts).end(url);
  }

  // url first
  if (1 == arguments.length) {
    return new exports.Request('GET', method, opts);
  }

  return new exports.Request(method, url, opts);
}
...
function Request(method, url, opts) {
  ...
  if (opts && opts.maxRedirects) this._maxRedirects = opts.maxRedirects;
}
